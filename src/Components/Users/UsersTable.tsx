...
import { Box, Paper, 
        Table, TableBody, TableCell, TableContainer, TableHead, tableCellClasses, TablePagination, TableRow, TableSortLabel, 
        Toolbar, Typography,
        Avatar, IconButton, Tooltip, FormControlLabel, Switch } from '@mui/material';
...
export default function UsersTable(userTableProps : UserTableProps) {

  const { userRows } = userTableProps;
  const userRowsUndefined = (userRows === undefined);
  const rows : UserTableRowValues[] = userRowsUndefined ? [] : userRows;
